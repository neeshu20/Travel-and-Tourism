...
function PackagesSection({ addToCart }) {
  ...
  const packages = [
    ...
    { id: 4, name: 'Mumbai Marine Package', city: 'Mumbai', price: 5500, image: image3 },
    { id: 5, name: 'West Delhi Package', city: 'Delhi', price: 10500, image: image2 },
    { id: 6, name: 'South Bangalore  Package', city: 'Bangalore', price: 6000, image: image1 },
    { id: 7, name: 'South Mumbai Package', city: 'Mumbai', price: 9500, image: image3 },
    { id: 8, name: 'South Delhi Package', city: 'Delhi', price: 3500, image: image2 }
  ];
  ...
  // Filtered packages based on selected city and price
  const filteredPackages = packages.filter(pkg => {
    // Filter by selected city
    if (selectedCity && pkg.city !== selectedCity) return false;
  ...
  // Function to handle adding package to cart
      ...
      <section className="review" id="review">
        ...
        <Row>
          <Col className='titlee'>
            ...
            <span className='rate'><img className='rate' src={star} /></span>
            <br></br>
            <p className='xt'>{text}</p>
            <Button onClick={jatin}>Delete</Button>
          </Col>
          <Col ></Col>            <Col></Col>
